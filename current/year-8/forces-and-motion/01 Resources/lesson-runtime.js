...
(() => {
  ...
  function content(p) {
    ...
    if(p.type==='eye')return `${heading}<iframe class="eye-embed" title="Rotatable labelled eye" src="01 Resources/eye-model.html?embed"></iframe><p class="bio-task">${p.task}</p>`;
